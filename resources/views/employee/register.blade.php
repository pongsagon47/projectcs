                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <div class="form-check form-check-inline" style="margin-left: 18px">
                                        <input class="form-check-input{{ $errors->has('last_name') ? ' is-invalid' : '' }}" type="radio" name="gender" id="male" value="ชาย">
                                        <label class="form-check-label" for="male">ชาย</label>
                                    </div>
                                    <div class="form-check form-check-inline" >
                                        <input class="form-check-input{{ $errors->has('last_name') ? ' is-invalid' : '' }}" type="radio" name="gender" id="female" value="หญฺิง">
