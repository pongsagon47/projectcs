                    ...
                    <div class="card-body">
                        <div class="form-row ">
                            <div class="col-md-12">
                                ...
                                <h3 class="text-center"><i class="fas fa-shopping-cart"></i> รายการผลิตห้องขนมบราวนี่</h3>
                                <div class="table-responsive" style="margin-top: 30px">
                                    ...
                                    <div class="text-center" style="padding-top: 9px">
                                        <a class="btn btn-danger" href="{{route('brownie-dessert.index')}}" >&laquo; กลับหน้ารายการสั่งซื้อ</a>
                                    </div>
