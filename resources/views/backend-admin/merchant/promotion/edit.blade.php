                            ...
                            <div class="form-group">
                                <div class="col-md-7">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ $promotion->promotion_name }}" id="promotion_name" name="promotion_name"
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ $promotion->promotion_description}}" id="promotion_description"
                            ...
                            <div class="form-group ">
                                <div class="col-md-2">
                                    ...
                                    <input type="number"
                                           ...
                                           value="{{ $promotion->promotion_discount }}" id="promotion_discount" name="promotion_discount">
                                ...
                                <div class="col-md-6">
                                    @if ($errors->has('promotion_discount'))
                                        <strong style="color: rgba(179,0,0,0.9);font-size: 13px">{{ $errors->first('discount') }}</strong>
                                    @endif
                                </div>
                            </div>
