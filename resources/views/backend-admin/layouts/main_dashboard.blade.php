...
<!-- Page Wrapper -->
<div id="wrapper">
    @include('backend-admin.partials.sidebar_user')
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        @include('backend-admin.partials.footer_user')
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="{{ route('logout.employee') }}" onclick="event.preventDefault();
