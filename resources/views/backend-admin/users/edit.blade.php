    ...
    <div class="container">
        <div class="row ">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header text-center"  style="font-size: 18px;background: linear-gradient(45deg, #289bff, #a5ffd5)">แก้ไขข้อมูลลูกค้า</div>
                        ...
                        <form method="POST" action="{{route('user.update',[array_get($data,'id')])}}" enctype="multipart/form-data" style="padding: 2rem">
                            ...
                            <div class="form-group">
                                <label for="status" class=" col-form-label text-md-right"
                                       style="font-size: 16.8px;">สถานะ</label>

                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="status" value="0" name="status" {{ 1 == array_get($data,'status')?'checked':'' }}>
