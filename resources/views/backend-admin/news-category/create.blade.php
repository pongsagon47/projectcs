...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header" style="background: linear-gradient(45deg, #219d1c, #bdff33); font-size: 19.5px; " >เพิ่มหมวดหมู่</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('news-category.store') }}">
                            ...
                            <div class="form-group row">
                                <label for="slug" class="col-md-4 col-form-label text-md-right" style="font-size: 17px;">URL หมวดหมู่</label>
