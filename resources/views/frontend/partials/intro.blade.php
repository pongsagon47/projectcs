<section id="intro">
    <div class="intro-text">
        <h2>ยินดีต้อนรับเข้าสู่ดินแดนขนม</h2>
        <p>คิดถึงเบเกอรี่ ยินดีต้อนรับลูกค้าทุกท่านที่มา <br> เยี่ยมชมเว็บไซต์ และสนใจที่จะเป็นหนึ่งในครอบครัวคิดถึงเบเกอรี่ของเราขนมของเราล้วนสดใหม่ทุกวันไม่มีสารกันบูด</p>
