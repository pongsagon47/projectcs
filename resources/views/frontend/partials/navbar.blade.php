<header id="header">
    <div class="container">
        ...
        <nav id="nav-menu-container">
            <ul class="nav-menu">
                <li class="menu-active"><a class="nav-index-link" href="{{route('kidthuang.index')}}">หน้าหลัก</a></li>
                <li><a class="nav-index-link" href="{{route('kidthuang.about-us')}}">เกี่ยวกับเรา</a></li>
                <li><a class="nav-index-link" href="#features">ข่าวสาร</a></li>
                <li><a class="nav-index-link" href="#pricing">ข้อมูลขนม</a></li>
                <li><a class="nav-index-link" href="#team">ติดต่อเรา</a></li>
                @if (Route::has('login'))
                    <li>
                        @auth
