        ...
        <div class="row justify-content-center">
            <div class="col-md-9">
                ...
                <div class="card" style="margin-top: 20px">
                    <div class="card-header" style="text-align: center; font-size: 19px; background: linear-gradient(45deg, #ff9913, #ffe764)">
                        ข้อมูลขนม
                    </div>
                    <div class="card-body">
                ...
                <div class="pull-right" style="margin-top: 22px ">
                    <a href="{{route('product-list.index')}}" class="btn btn-primary "> back </a>
                </div>
