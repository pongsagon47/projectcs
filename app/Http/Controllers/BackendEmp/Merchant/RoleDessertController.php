...
class RoleDessertController extends Controller
{
    public function index()
    {
        ...
        return view('backend-admin.merchant.role-dessert.index',compact('orders'));
    }
    ...
    public function show($id)
    {
        ...
        $orderDetails = OrderDetail::query()
            ...
            ->where('role_employee_id',5)
            ->get();
        return view('backend-admin.merchant.role-dessert.detail',compact('order','orderDetails'));
    }
    ...
    public function confirm($id)
    {
        ...
        $productionStatus->role_dessert = 1;
        ...
        return redirect()->route('role-dessert.index')->with('success','รับรายการผลิตสาขา '.$productionStatus->order->user->shop_name.' เรียบร้อย');
    }
    ...
    public function dessertMaker()
    {
        ...
        return view('backend-admin.merchant.role-dessert.dessert_maker',compact('orderDetails'));
    }
    ...
    public function orderSuccess($id)
    {
        ...
        $productionStatus->role_dessert = 2;
        ...
        return redirect()->route('role-dessert.index')->with('success', "รายการผลิต ".$productionStatus->order->user->shop_name." เสร็จแล้ว");
    }
}
