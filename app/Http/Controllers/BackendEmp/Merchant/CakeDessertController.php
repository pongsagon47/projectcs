...
class CakeDessertController extends Controller
{
    public function index()
    {
        ...
        return view('backend-admin.merchant.cake-dessert.index',compact('orders'));
    }
    ...
    public function confirm($id)
    {
        ...
        $productionStatus->cake_dessert = 1;
        ...
        return redirect()->route('cake-dessert.index')->with('success','รับรายการผลิตสาขา '.$productionStatus->order->user->shop_name.' เรียบร้อย');
    }
    ...
    public function dessertMaker()
    {
        ...
        return view('backend-admin.merchant.cake-dessert.dessert_maker',compact('orderDetails'));
    }
    ...
    public function orderSuccess($id)
    {
        ...
        $productionStatus->cake_dessert = 2;
        ...
        return redirect()->route('cake-dessert.index')->with('success', "รายการผลิต ".$productionStatus->order->user->shop_name." เสร็จแล้ว");
    }
}
